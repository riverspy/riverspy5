...
//	else
	...
	if (validReads != 0)
		meanDist = Total / validReads;		// use the average value of the readings
	else
		meanDist = 0;
	...
	if (validReads != 0)
		Levels[Slot] = Offset - (int)(ScaleFactor * meanDist);		// scale to cm and add any offset due to sensor being above the 0cm level of the river
	else
		Levels[Slot] = 0;
